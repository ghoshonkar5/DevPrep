...
export const TCS_COACH_TOPICS: CoachTopic[] = [
  ...
  },
  {
    ...
    category: 'Aptitude',
    refresher: [
      'Triangles: Area = ½ × base × height; Area (Heron\'s) = √[s(s-a)(s-b)(s-c)] where s = (a+b+c)/2.',
      'Pythagoras: a² + b² = c² (right triangle). Pythagorean triplets: (3,4,5), (5,12,13), (8,15,17), (7,24,25).',
      'Circles: Area = πr²; Circumference = 2πr; Arc length = (θ/360) × 2πr; Sector area = (θ/360) × πr².',
      'Rectangles & Squares: Rectangle Area = l × b, Perimeter = 2(l + b), Diagonal = √(l² + b²). Square Area = a², Diagonal = a√2.',
    ],
    formulas: [
      '3D Mensuration: Cylinder Volume = πr²h, Total Surface Area = 2πr(r + h).',
      'Cone Volume = (1/3)πr²h, Slant height l = √(r² + h²), Lateral Surface Area = πrl.',
      'Sphere Volume = (4/3)πr³, Surface Area = 4πr²; Hemisphere Volume = (2/3)πr³, Total Surface Area = 3πr².',
    ],
    shortcuts: [
    ...
    practiceQuestions: [
      { q: 'The sides of a triangle are 5 cm, 12 cm and 13 cm. What is its area?', options: ['(a) 30 cm²', '(b) 60 cm²', '(c) 25 cm²', '(d) 65 cm²'] },
      { q: 'If the radius of a circle is increased by 50%, by what percentage does its area increase?', options: ['(a) 100%', '(b) 125%', '(c) 150%', '(d) 225%'] },
      { q: 'A rectangular field is 80m long and 60m wide. What is the length of its diagonal?', options: ['(a) 90m', '(b) 100m', '(c) 110m', '(d) 120m'] },
      { q: 'The perimeter of a square is 48 cm. What is the length of its diagonal?', options: ['(a) 12√2 cm', '(b) 12 cm', '(c) 24√2 cm', '(d) 18 cm'] },
      { q: 'The volume of a cylinder with radius 7 cm and height 10 cm is (use π = 22/7):', options: ['(a) 1540 cm³', '(b) 1440 cm³', '(c) 1640 cm³', '(d) 1340 cm³'] },
      { q: 'If the height of a cone is doubled while keeping its base radius same, its volume increases by:', options: ['(a) 50%', '(b) 100%', '(c) 200%', '(d) 300%'] },
      { q: 'What is the surface area of a sphere of radius 7 cm?', options: ['(a) 616 cm²', '(b) 308 cm²', '(c) 154 cm²', '(d) 462 cm²'] },
      { q: 'In an equilateral triangle of side 6 cm, find its height.', options: ['(a) 3√3 cm', '(b) 6√3 cm', '(c) 3 cm', '(d) 4√3 cm'] },
      { q: 'A wheel makes 1000 revolutions to cover a distance of 88 km. Find the diameter of the wheel.', options: ['(a) 28m', '(b) 14m', '(c) 24m', '(d) 32m'] },
      { q: 'The ratio of areas of two squares is 9:16. What is the ratio of their perimeters?', options: ['(a) 3:4', '(b) 9:16', '(c) 81:256', '(d) 4:3'] },
    ],
    pyqTraps: [
      { title: 'Trap 1 — Radius vs Diameter', desc: 'Questions give diameter but formulas require radius r. Students plug in diameter directly into πr² or 4/3πr³.' },
      { title: 'Trap 2 — Percentage Area Change', desc: 'If radius increases by 20%, area does NOT increase by 20% or 40%. It increases by 20 + 20 + (20×20/100) = 44%!' },
      { title: 'Trap 3 — Hemisphere Total Surface Area', desc: 'Curved surface area of hemisphere is 2πr², but TOTAL surface area includes the flat circular base (+πr²), making it 3πr²! TCS frequently traps students here.' },
    ],
  },
];
